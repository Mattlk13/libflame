/* ../netlib/slarf1f.f -- translated by f2c (version 20100827). You must link the resulting object
...
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/slarf1f.f
 * "> */
/* > [TGZ]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/slarf1f.f
 * "> */
/* > [ZIP]</a> */
/* > <a
 * href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/slarf1f.f
 * "> */
/* > [TXT]</a> */
/* > \endhtmlonly */
/* Definition: */
              ...
              real *c__, aocl_int_t *ldc, real *work)
{
    ...
    aocl_lapack_slarf1f(side, &m_64, &n_64, v, &incv_64, tau, c__, &ldc_64, work);
#endif
}
                         ...
                         real *tau, real *c__, aocl_int64_t *ldc, real *work)
{
    ...
    if(applyleft)
    {
        ...
        else
        {
            ...
            r__1 = -(*tau);
            aocl_blas_saxpy(&lastc, &r__1, &work[1], &c__1, &c__[c_offset], ldc);
    ...
    else
    {
        ...
        else
        {
            ...
            r__1 = -(*tau);
            aocl_blas_saxpy(&lastc, &r__1, &work[1], &c__1, &c__[c_offset], &c__1);
